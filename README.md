...
## 📅 學習日誌
* **2026-02-09:** 完成 GitHub 倉庫結構化整理，建立 `Syntax_test` 與 `diagrams` 分類；上傳第一個練習題（水仙花數）。
* **2026-02-24：** 完成 HackMD 與 GitHub 儲存庫 Coding-study-C 的同步設定，將學習心得整合至 main 分支並優化 README.md 專案簡介；上傳第二個練習題（找完美數）。
* **2026-02-25：** 思考如何優化 GitHub 記錄與規劃如何讓紀錄更好看😎；上傳第三個練習題（判斷迴文數）。
* **2026-02-26：** 優化 GitHub 記錄以及讓紀錄更好看😇；上傳第四個練習題（費氏數列）。
* * **2026-03-02：** 整理了一下題目。
